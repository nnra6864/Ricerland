...
css = """<style id="light">
    ...
    body {
        --body-bg: #ricer.col.background;
        --bg-alt-1: #ricer.col.background_alt;
        --bg-alt-2: #ricer.col.background;
        --bg-alt-3: #ricer.col.background_alt;
        --bg-alt-4: #ricer.col.background;
        --bg-alt-5: #ricer.col.background_alt;
        --main-text: #ricer.col.foreground;
        --main-text-a50: rgb(ricer.col.foreground.rgb / 50%);
        --text-lighter-1: #ricer.col.foreground_highlight;
        --text-lighter-2: #ricer.col.foreground_highlight;
        --text-darker-1: #ricer.col.foreground_inactive;
        --text-darker-2: #ricer.col.foreground_disabled;
        --medium: #ricer.col.foreground;
        --medium-lighter-1: #ricer.col.foreground_highlight;
        --badge-gray: var(--body-bg);
        --black-a30: rgba(ricer.col.black.rgb, 0.3);
    }
