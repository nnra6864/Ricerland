...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"ricer.col.foreground.format(r g b a)"	// used in text windows, lists
		"BrightBaseText"	"ricer.col.foreground_highlight.format(r g b a)"	// brightest text
		"SelectedText"		"ricer.col.foreground_highlight.format(r g b a)"	// selected text
		"DimBaseText"		"ricer.col.foreground_placeholder.format(r g b a)"	// dim base text
		"LabelDimText"		"ricer.col.foreground_placeholder.format(r g b a)"	// used for info text
		"ControlText"		"ricer.col.button_foreground.format(r g b a)"	// used in all text controls
		"BrightControlText"	"ricer.col.button_foreground_highlight.format(r g b a)"	// use for selected controls
		"DisabledText1"		"ricer.col.foreground_disabled.format(r g b a)"	// disabled text
		...
		"ListBG"			"ricer.col.background.format(r g b) 0"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"ricer.col.foreground.format(r g b a)"
		"TitleDimText"		"ricer.col.foreground_inactive.format(r g b a)"
		"TitleBG"			"0 0 0 0"
		"TitleDimBG"		"0 0 0 0"

		// slider tick colors
		"SliderTickColor"	"ricer.col.button_foreground.format(r g b a)"
